...
file = Path("recommendation.py")

text = file.read_text()

start = text.index("def explain_car(car):")

new_function = """def explain_car(car):
...
print("recommendation.py aangepast naar watchlist gebaseerde uitleg")
